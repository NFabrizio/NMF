...
# data_small="./test_data/small_data.dat"
# data_medium="./test_data/med_data.dat"
# data_large="./test_data/large_data.dat"
# declare -a data_sets=("./test_data/small_data.dat"
#                       "./test_data/med_data.dat"
#                       "./test_data/large_data.dat"
#                       )
...
# Set up file headers
echo "program,data_set,n,i,t,b,iter_0,iter_1,iter_2,iter_3,iter_4,iter_5,iter_6" >> $RESULT_FILE
...
for (( n=2 ; n<7 ; n+=5 )); do
  ...
  # for p in {2..6}; do
    printf "$PROGRAM1,$data_set,$N,$I,$T,$B" >> $RESULT_FILE
    ...
    if [ $ITER1 == 0 ]; then
      while [ $ITER1 -lt 7 ]; do
        ...
        echo "ITER: $ITER1 for $PROGRAM1 for data_set=$data_set, n=$N, i=$I, t=$T, b=$B"
...
for (( n=2 ; n<length ; n+=5 )); do
  ...
  printf "$PROGRAM2,$data_set,$N,$I,$T,$B" >> $RESULT_FILE
  ...
  while [ $ITER -lt 7 ]; do
    ...
    echo "ITER: $ITER for $PROGRAM2 for data_set=$data_set, n=$N, i=$I, t=$T, b=$B"
